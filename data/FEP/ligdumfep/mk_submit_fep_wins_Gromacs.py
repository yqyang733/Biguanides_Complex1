...
cd em
if [ ! -f em.tpr ]; then
    gmx grompp -f ../em.mdp -c ../../../frame.gro -p ../../../topol.top -r ../../../frame.gro -o em.tpr -maxwarn 2
fi
...
cd ../nvt
if [ ! -f nvt.tpr ];then
    gmx grompp -f ../nvt.mdp -c ../em/em.gro -p ../../../topol.top -o nvt.tpr -r ../em/em.gro -maxwarn 4 -n ../../../index.ndx
fi
...
cd ../npt
if [ ! -f npt.tpr ];then
    gmx grompp -f ../npt.mdp -c ../nvt/nvt.gro -t ../nvt/nvt.cpt -p ../../../topol.top -o npt.tpr -r ../nvt/nvt.gro -maxwarn 4 -n ../../../index.ndx
fi
...
cd ../prod
if [ ! -f prod.tpr ];then
    gmx grompp -f ../md.mdp -c ../npt/npt.gro -t ../npt/npt.cpt -p ../../../topol.top -o prod.tpr -r ../npt/npt.gro -maxwarn 4 -n ../../../index.ndx
fi
